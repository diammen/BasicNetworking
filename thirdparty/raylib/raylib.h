...
typedef struct NPatchInfo {
    Raytangle sourceRec;   // Region in the texture
...
typedef struct Font {
    ...
    Raytangle *recs;        // Characters rectangles in texture
...
RLAPI void RayHideCursor(void);                                      // Hides cursor
...
RLAPI void DrawRectangleRec(Raytangle rec, Color color);                                                 // Draw a color-filled rectangle
RLAPI void DrawRectanglePro(Raytangle rec, Vector2 origin, float rotation, Color color);                 // Draw a color-filled rectangle with pro parameters
RLAPI void DrawRectangleGradientV(int posX, int posY, int width, int height, Color color1, Color color2);// Draw a vertical-gradient-filled rectangle
RLAPI void DrawRectangleGradientH(int posX, int posY, int width, int height, Color color1, Color color2);// Draw a horizontal-gradient-filled rectangle
RLAPI void DrawRectangleGradientEx(Raytangle rec, Color col1, Color col2, Color col3, Color col4);       // Draw a gradient-filled rectangle with custom vertex colors
RLAPI void DrawRectangleLines(int posX, int posY, int width, int height, Color color);                   // Draw rectangle outline
RLAPI void DrawRectangleLinesEx(Raytangle rec, int lineThick, Color color);                              // Draw rectangle outline with extended parameters
RLAPI void DrawRectangleRounded(Raytangle rec, float roundness, int segments, Color color);              // Draw rectangle with rounded edges
RLAPI void DrawRectangleRoundedLines(Raytangle rec, float roundness, int segments, int lineThick, Color color); // Draw rectangle with rounded edges outline
...
RLAPI void SetShapesTexture(Texture2D texture, Raytangle source);                                        // Define default texture used to draw shapes

// Basic shapes collision detection functions
RLAPI bool CheckCollisionRecs(Raytangle rec1, Raytangle rec2);                                           // Check collision between two rectangles
RLAPI bool CheckCollisionCircles(Vector2 center1, float radius1, Vector2 center2, float radius2);        // Check collision between two circles
RLAPI bool CheckCollisionCircleRec(Vector2 center, float radius, Raytangle rec);                         // Check collision between circle and rectangle
RLAPI Raytangle GetCollisionRec(Raytangle rec1, Raytangle rec2);                                         // Get collision rectangle for two rectangles collision
RLAPI bool CheckCollisionPointRec(Vector2 point, Raytangle rec);                                         // Check if point is inside rectangle
...
RLAPI Raytangle GetImageAlphaBorder(Image image, float threshold);                                       // Get image alpha border rectangle
...
RLAPI Image ImageFromImage(Image image, Raytangle rec);                                                  // Create an image from another image piece
...
RLAPI void ImageCrop(Image *image, Raytangle crop);                                                      // Crop an image to a defined rectangle
...
RLAPI void ImageDraw(Image *dst, Image src, Raytangle srcRec, Raytangle dstRec, Color tint);             // Draw a source image within a destination image (tint applied to source)
RLAPI void ImageDrawRectangle(Image *dst, Raytangle rec, Color color);                                   // Draw rectangle within an image
RLAPI void ImageDrawRectangleLines(Image *dst, Raytangle rec, int thick, Color color);                   // Draw rectangle lines within an image
...
RLAPI void DrawTextureRec(Texture2D texture, Raytangle sourceRec, Vector2 position, Color tint);         // Draw a part of a texture defined by a rectangle
RLAPI void DrawTextureQuad(Texture2D texture, Vector2 tiling, Vector2 offset, Raytangle quad, Color tint);  // Draw texture quad with tiling and offset parameters
RLAPI void DrawTexturePro(Texture2D texture, Raytangle sourceRec, Raytangle destRec, Vector2 origin, float rotation, Color tint);       // Draw a part of a texture defined by a rectangle with 'pro' parameters
RLAPI void DrawTextureNPatch(Texture2D texture, NPatchInfo nPatchInfo, Raytangle destRec, Vector2 origin, float rotation, Color tint);  // Draws a texture (or part of it) that stretches or shrinks nicely
...
RLAPI Image GenImageFontAtlas(const CharInfo *chars, Raytangle **recs, int charsCount, int fontSize, int padding, int packMethod);  // Generate image font atlas using chars info
...
RLAPI void DrawTextRec(Font font, const char *text, Raytangle rec, float fontSize, float spacing, bool wordWrap, Color tint);   // Draw text using font inside rectangle limits
RLAPI void DrawTextRecEx(Font font, const char *text, Raytangle rec, float fontSize, float spacing, bool wordWrap, Color tint,
...
RLAPI void DrawBillboardRec(Camera camera, Texture2D texture, Raytangle sourceRec, Vector3 center, float size, Color tint); // Draw a billboard texture defined by sourceRec
